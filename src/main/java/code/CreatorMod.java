...
@SpireInitializer
public class CreatorMod implements
        EditCardsSubscriber,
    ...
    public static final String modID = "creator"; //TODO: Change this.
    ...
    public CreatorMod() {
        ...
        BaseMod.addColor(CreatorCharacter.Enums.CREATOR_COLOR, characterColor, characterColor, characterColor,
    ...
    public static void initialize() {
        CreatorMod thismod = new CreatorMod();
    }

    @Override
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new CreatorCharacter(CreatorCharacter.characterStrings.NAMES[1], CreatorCharacter.Enums.THE_CREATOR),
            CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, CreatorCharacter.Enums.THE_CREATOR);
