...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(CreatorMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(CreatorMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(CreatorMod.makeImagePath("masks/PowerMask.png"));
