...
import static code.CreatorCharacter.Enums.CREATOR_COLOR;
import static code.CreatorMod.*;

public class CreatorCharacter extends CustomPlayer {
    ...
    public CreatorCharacter(String name, PlayerClass setClass) {
    ...
    public AbstractPlayer newInstance() {
        return new CreatorCharacter(name, chosenClass);
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_CREATOR;
        @SpireEnum(name = "CREATOR_COLOR")
        public static AbstractCard.CardColor CREATOR_COLOR;
        @SpireEnum(name = "CREATOR_COLOR")
        @SuppressWarnings("unused")
        public static CardLibrary.LibraryType CREATOR_LIBRARY_COLOR;
    }
}
